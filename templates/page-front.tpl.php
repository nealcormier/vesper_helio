...
<?php if ($page['slideshow_first']): ?>
      <div id="slideshow_first" class="column"><div class="section">
        <?php print render($page['slideshow_first']); ?>
      </div></div> 
    <?php endif; ?>
    ...
    <div id="shorthand">
      <?php print render($page['shorthand']); ?>
    </div>
